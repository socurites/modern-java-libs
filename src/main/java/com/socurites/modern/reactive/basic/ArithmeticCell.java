...
public class ArithmeticCell extends NewSimpleCell {
	private int left;
	private int right;
	...
	private static void test1() {
		...
		NewSimpleCell c2 = new NewSimpleCell("C2");
		NewSimpleCell c1 = new NewSimpleCell("C1");
	...
	private static void test2() {
		...
		ArithmeticCell c3 = new ArithmeticCell("C3");
		NewSimpleCell c4 = new NewSimpleCell("C4");
		NewSimpleCell c2 = new NewSimpleCell("C2");
		NewSimpleCell c1 = new NewSimpleCell("C1");
